...
import { ChevronLeft, EllipsisVertical, Loader2Icon } from "lucide-react";
    ...
    <div className="grid h-15 flex-shrink-0 grid-cols-3 items-center border-b px-6 py-3">
      <div className="flex min-w-0 items-center gap-2 overflow-hidden text-gray-700">
        <Button
          variant="ghost"
          onClick={router.back}
          className="flex max-w-full min-w-0 cursor-pointer items-center gap-2 !p-0 !transition-all hover:bg-transparent hover:text-gray-700"
        >
      ...
      <div className="flex min-w-0 items-center justify-center">
        <Popover>
          <PopoverTrigger className="flex max-w-full min-w-0 items-center justify-center">
      ...
      <div className="flex items-center justify-end">
        <DropdownMenu>
          <DropdownMenuTrigger asChild>
            <Button variant="ghost" className="cursor-pointer !transition-all">
